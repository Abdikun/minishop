...
import HeaderMinishop from '@/components/HeaderMinishop.vue'
import FooterMinishop from '@/components/FooterMinishop.vue'
import RelatedMinishop from '@/components/RelatedMinishop.vue'
